...
describe("tutorial registry", () => {
  it("registers the URL Shortener, Rate Limiter, Pastebin, Notification Service, Ticket Booking, Video Streaming, and Collaborative Doc Editor tutorials", () => {
    expect(Object.keys(tutorials).sort()).toEqual(["collaborative-doc-editor", "notification-service", "pastebin", "rate-limiter", "ticket-booking", "url-shortener", "video-streaming"]);
  });

  it("describes the URL Shortener's eighteen sections, the Rate Limiter's fifteen, the Pastebin's eighteen, the Notification Service's eighteen, the Ticket Booking's eighteen, the Video Streaming's eighteen, and the Collaborative Doc Editor's eighteen", () => {
